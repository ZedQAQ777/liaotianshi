...
import socket.utils.ServerConfig;
import socket.vo.UFile;
import socket.vo.UploadFile;
...
public class FileUploadController {
    ...
    String uploadFile(@RequestParam(value = "file", required = false) MultipartFile file, int userId, HttpServletRequest request) {
        ...
        try {
            ...
            UFile uf = new UFile();
            uf.setName(fileName);
            uf.setSrc(serverConfig.getRoot() + "/sns/downLoadFile?downLoadPath=" + downLoadPath + "&fileName=" + fileName);
            upFile.setData(uf);
        } catch (Exception e) {
            e.printStackTrace();
        }
